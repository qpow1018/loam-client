            ...
            <details className={styles['difficulty-item']} key={difficulty.id} open={index === 0}>
              <summary className={styles['difficulty-summary']}>
                <div className={styles['summary-item']}>
                  <strong
                    className={`${styles['difficulty-badge']} ${styles[`tone-${difficulty.tone}`]}`}
                  >
                    {difficulty.name}
                  </strong>
                </div>
                <div className={styles['summary-item']}>
                  <span>입장 레벨</span>
                  <strong className={styles['entry-level']}>Lv. {difficulty.entryItemLevel}</strong>
                </div>
                <div className={`${styles['summary-item']} ${styles['gold-summary']}`}>
                  <span>골드</span>
                  <strong>{formatGold(summary.totalGold)} G</strong>
                </div>
              </summary>
